...
<html>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
  ...
  List<Usuarios> resultado = op.update(id);
         
      for(Usuarios u:resultado){
    %>
        
       
 <div class="form-group"><label>Id</label></div>
 <div class="form-group">
 <input type="text" name="id"  class="form-control" value="<%=u.getIdUsuarios()%>">
     </div>
     
 <div class="form-group"><label>Nombre</label></div>
 <div class="form-group"> 
  <input type="text" class="form-control" name="nombre" value="<%=u.getNombUsu()%>">
       </div>
       
  <div class="form-group"><label>cedula</label></div>
 <div class="form-group">      
<input type="text" class="form-control" name="cedula" value="<%=u.getCedulUsu()%>">
 </div>
